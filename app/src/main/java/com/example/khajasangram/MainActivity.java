...
public class MainActivity extends AppCompatActivity {
    TextInputEditText email_txt,pw_txt;
    Button login_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        email_txt = (TextInputEditText) findViewById(R.id.email_login);
        pw_txt = (TextInputEditText) findViewById(R.id.password_login);
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                if (mAuth.getCurrentUser().isEmailVerified()) {
                                    Toast.makeText(MainActivity.this, "New Activity will open here", Toast.LENGTH_SHORT).show();
